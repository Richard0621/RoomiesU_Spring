    ...
    protected void doFilterInternal(@NotNull HttpServletRequest request,
        ...
        if (tokenHeader != null && tokenHeader.startsWith("Bearer ")) {
            ...
            if (jwtUtils.isTokenValid(token)) {
                String email = jwtUtils.getUsernameFromToken(token); // El metodo sigue llamándose getUsernameFromToken pero ahora devuelve el email
                UserDetails userDetails = userDetailsService.loadUserByUsername(email); // Internamente busca por email
