...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException { // Cambiado el parámetro a email
        // Se busca el usuario por su email en lugar de username
        Usuario usuario = usuarioRepositorio.findByEmail(email) // Cambiado a findByEmail
        ...
        // Se construye el UserDetails con el email como username
        return new User(
